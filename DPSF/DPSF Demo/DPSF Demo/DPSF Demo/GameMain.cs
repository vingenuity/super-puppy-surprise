...
namespace Demo
{
	...
	public class GameMain : Microsoft.Xna.Framework.Game
	{
		...
		// Whether we should draw how much memory is set to be collected by the Garbage Collector
		bool mbDrawGarbageCollectorMemoryAllocated = false;
		...
		enum EPSEffects
		{
			...
			LastInList = 38     // This value should be the same as the Effect with the largest value
		}
		...
		void DrawText()
		{
			...
			if (mbDrawGarbageCollectorMemoryAllocated)
